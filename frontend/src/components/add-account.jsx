...
export const AddAccount = ({ isOpen, setIsOpen, refetch }) => {
  ...
  return (
    <DialogWrapper isOpen={isOpen} closeModal={closeModal}>
      <DialogPanel
        className="w-full max-w-md transform overflow-hidden rounded-2x1 bg-white dark:bg-slate-900 p-6 text-left 
    align-middle shadow-xl transition-all opacity-100 scale-100"
      >
        <DialogTitle
          as="h3"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="fex flex-col gap-1 mb-2">
            ...
            text-gray-700 dark:text-gray-700 outline-none focus:ring-1 ring-blue-500 dark:placeholder:text-gray-700"
            >
          ...
          {user?.accounts?.includes(selectedAccount) && (
            <div className="flex items-center gap-2bg-yellow-400 text-black p-2 mt-6 rounded">
