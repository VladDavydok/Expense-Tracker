...
import AccountMenu from '../components/accounts-dialog';
import { maskAccountNumber, formatCurrency } from '../libs/index';
            ...
            {data?.map((acc, index) => (
              ...
              >
                ...
                <div className="space-y-2 w-full">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="text-xltext-gray-600 dark: text-gray-400 font-medium">
